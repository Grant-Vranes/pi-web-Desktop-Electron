...
export const zhTWLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "settings.proxy.enabledLabel": "透過此代理轉發對外網路請求",
    "settings.proxy.connection": "代理連線",
    "settings.proxy.protocol": "協定",
    "settings.proxy.host": "主機",
    "settings.proxy.port": "連接埠",
    "settings.proxy.username": "使用者名稱",
    "settings.proxy.usernamePlaceholder": "選用",
    "settings.proxy.password": "密碼",
    "settings.proxy.passwordPlaceholder": "選用",
    "settings.proxy.passwordKept": "(已儲存)",
    "settings.proxy.testUrl": "測試位址",
    "settings.proxy.test": "測試連線",
    "settings.proxy.testing": "測試中…",
    "settings.proxy.testSuccess": "連線成功",
    "settings.proxy.testFailed": "連線失敗",
    "settings.proxy.incomplete": "需要填寫主機與有效連接埠(1–65535)。",
    "settings.proxy.save": "儲存",
    "settings.proxy.disable": "停用代理",
    "settings.proxy.savedRestart": "已儲存。重新啟動 Pi Web 後代理才會生效。",
    "settings.proxy.disabledRestart": "已停用代理。重新啟動 Pi Web 後才會生效。",
    "settings.proxy.howItWorksTitle": "運作方式",
    "settings.proxy.howItWorks": "憑證以私有方式儲存在 ~/.pi/agent/proxy.json。代理在 Pi Web 啟動時生效，因此此處修改後需重新啟動才能生效。可使用「測試連線」即時檢查，無需重新啟動。",
    "auth.prompt": "登入後繼續使用",
    "auth.password": "密碼",
    "auth.logIn": "登入",
    "auth.loggingIn": "正在登入...",
    ...
    "history.label": "完整紀錄",
    "terminal.open": "在工作階段目錄開啟終端機",
    "terminal.openShort": "終端機",
    "terminal.opening": "正在開啟終端機…",
    "terminal.openFailed": "開啟終端機失敗",
    "terminal.commandCopied": "終端機啟動失敗——命令已複製到剪貼簿，請自行開啟終端機後貼上：",
    ...
    "sidebar.worktreeLockedTitle": "目前工作階段已開始，worktree 已鎖定。请新增工作階段中切換或建立 worktree。",
    "sidebar.main": "主分支",
    ...
    "sidebar.noArchivedSessions": "暫無封存工作階段",
    "sidebar.agentRunning": "Agent 執行中…",
    "sidebar.newActivity": "有新活動",
    "sidebar.newSessionActivity": "工作階段有新活動",
    "sidebar.projectRunningCount": "{count} 個工作階段執行中",
    "sidebar.projectNotRunning": "暫無執行中的工作階段",
    "sidebar.projectUnreadCount": "{count} 個已完成的工作階段待查看",
    "sidebar.sessionCompleted": "已完成",
    "sidebar.noBranch": "無分支",
    "sidebar.modelUnknown": "模型未知",
    "sidebar.deleteSession": "刪除 {title}？",
    "sidebar.deleteProject": "刪除專案…",
    "sidebar.deleteProjectConfirm": "刪除 {count} 個會話（不可復原）",
    "sidebar.deleteProjectCount": "將刪除該專案下的全部會話及其磁碟檔案,無法復原。",
    ...
    "sidebar.rename": "重新命名",
    "sidebar.renameProject": "重新命名專案",
    "sidebar.delete": "刪除",
    "sidebar.deleteWithShiftClick": "刪除（按住 Shift 點選可跳過確認）",
    "sidebar.archive": "封存",
    "sidebar.archiveTitle": "移至封存",
    "sidebar.archiveAllTitle": "封存該組全部工作階段",
    "sidebar.unarchive": "取消封存",
    "sidebar.unarchiveTitle": "從封存還原",
    "sidebar.unarchiveAllTitle": "還原該組全部工作階段",
    "sidebar.tabConversations": "工作階段",
    "sidebar.tabArchive": "封存",
    ...
    "files.newFileSibling": "新增檔案（同層目錄）",
    "files.newFolderSibling": "新增資料夾（同層目錄）",
    "files.newFileInside": "新增檔案（內部）",
    "files.newFolderInside": "新增資料夾（內部）",
    "files.rename": "重新命名",
    "files.delete": "刪除",
    "files.fileName": "名稱",
    "files.create": "建立",
    "files.confirmDelete": "將 {name} 移到垃圾桶？",
    "files.confirmDeleteDirectory": "將 {name} 及其中的所有內容移到垃圾桶？",
    "files.operationFailed": "檔案操作失敗",
    "files.dismissOperationError": "關閉檔案操作錯誤",
    "files.dropToMove": "移動至 {name}",
    "files.copy": "複製",
    "files.cut": "剪下",
    "files.paste": "貼上",
    ...
    "terminal.openWorkspace": "開啟工作區終端機",
    ...
    "chat.fontSmaller": "縮小對話字體",
    "chat.fontLarger": "放大對話字體",
    "chat.fontReset": "重置對話字體",
    "chat.fontSize": "對話字體大小",
