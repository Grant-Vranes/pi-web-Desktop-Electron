...
export const enLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "settings.proxy.enabledLabel": "Route outbound network requests through this proxy",
    "settings.proxy.connection": "Proxy connection",
    "settings.proxy.protocol": "Protocol",
    "settings.proxy.host": "Host",
    "settings.proxy.port": "Port",
    "settings.proxy.username": "Username",
    "settings.proxy.usernamePlaceholder": "optional",
    "settings.proxy.password": "Password",
    "settings.proxy.passwordPlaceholder": "optional",
    "settings.proxy.passwordKept": "(stored)",
    "settings.proxy.testUrl": "Test URL",
    "settings.proxy.test": "Test connection",
    "settings.proxy.testing": "Testing...",
    "settings.proxy.testSuccess": "Connected",
    "settings.proxy.testFailed": "Connection failed",
    "settings.proxy.incomplete": "Host and a valid port (1–65535) are required.",
    "settings.proxy.save": "Save",
    "settings.proxy.disable": "Disable proxy",
    "settings.proxy.savedRestart": "Saved. Restart Pi Web for the proxy to take effect.",
    "settings.proxy.disabledRestart": "Proxy disabled. Restart Pi Web for the change to take effect.",
    "settings.proxy.howItWorksTitle": "How it works",
    "settings.proxy.howItWorks": "Credentials are stored privately in ~/.pi/agent/proxy.json. The proxy is applied when Pi Web starts, so changing it here takes effect after a restart. Use \"Test connection\" to check it immediately without restarting.",
    ...
    "terminal.open": "Open terminal at session directory",
    "terminal.openShort": "Terminal",
    "terminal.opening": "Opening terminal…",
    "terminal.openFailed": "Failed to open terminal",
    "terminal.commandCopied": "Terminal launch failed — command copied to clipboard. Open a terminal yourself and paste:",
    ...
    "sidebar.projectRunningCount": "{count} running session(s)",
    "sidebar.projectNotRunning": "No running sessions",
    "sidebar.projectUnreadCount": "{count} finished session(s) to check",
    "sidebar.sessionCompleted": "completed",
    "sidebar.noBranch": "no branch",
    "sidebar.modelUnknown": "model unknown",
    ...
    "sidebar.deleteProjectCount": "This deletes every session for this project, including its files on disk, and cannot be undone.",
    ...
    "sidebar.archiveTitle": "Move to archive",
    "sidebar.archiveAllTitle": "Archive all in this group",
    "sidebar.unarchive": "Unarchive",
    "sidebar.unarchiveTitle": "Restore from archive",
    "sidebar.unarchiveAllTitle": "Restore all in this group",
    "sidebar.tabConversations": "Conversations",
    "sidebar.tabArchive": "Archive",
    ...
    "files.newFileSibling": "New File (same folder)",
    "files.newFolderSibling": "New Folder (same folder)",
    "files.newFileInside": "New File (inside)",
    "files.newFolderInside": "New Folder (inside)",
    "files.rename": "Rename",
    "files.delete": "Delete",
    "files.fileName": "Name",
    "files.create": "Create",
    "files.confirmDelete": "Move {name} to the Trash?",
    "files.confirmDeleteDirectory": "Move {name} and all of its contents to the Trash?",
    ...
    "terminal.openWorkspace": "Open workspace terminal",
    ...
    "chat.fontSmaller": "Decrease chat font size",
    "chat.fontLarger": "Increase chat font size",
    "chat.fontReset": "Reset chat font size",
    ...
    "i18n.branches": "Dialogue divergence",
    "i18n.noActiveSession": "No active session",
    "i18n.noBranches": "This session has no dialogue divergence",
    "i18n.source": "Source",
