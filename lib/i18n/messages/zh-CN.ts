...
export const zhCNLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "settings.proxy.enabledLabel": "通过此代理转发对外网络请求",
    "settings.proxy.connection": "代理连接",
    "settings.proxy.protocol": "协议",
    "settings.proxy.host": "主机",
    "settings.proxy.port": "端口",
    "settings.proxy.username": "用户名",
    "settings.proxy.usernamePlaceholder": "可选",
    "settings.proxy.password": "密码",
    "settings.proxy.passwordPlaceholder": "可选",
    "settings.proxy.passwordKept": "(已存储)",
    "settings.proxy.testUrl": "测试地址",
    "settings.proxy.test": "测试连接",
    "settings.proxy.testing": "测试中…",
    "settings.proxy.testSuccess": "连接成功",
    "settings.proxy.testFailed": "连接失败",
    "settings.proxy.incomplete": "需要填写主机和有效端口(1–65535)。",
    "settings.proxy.save": "保存",
    "settings.proxy.disable": "禁用代理",
    "settings.proxy.savedRestart": "已保存。重启 Pi Web 后代理才会生效。",
    "settings.proxy.disabledRestart": "已禁用代理。重启 Pi Web 后才会生效。",
    "settings.proxy.howItWorksTitle": "工作原理",
    "settings.proxy.howItWorks": "凭据以私有方式存储在 ~/.pi/agent/proxy.json 中。代理在 Pi Web 启动时生效，因此此处修改后需重启才能生效。可使用“测试连接”即时检查，无需重启。",
    "auth.prompt": "登录后继续使用",
    "auth.password": "密码",
    "auth.logIn": "登录",
    "auth.loggingIn": "正在登录...",
    ...
    "history.label": "完整历史",
    "terminal.open": "在会话目录打开终端",
    "terminal.openShort": "终端",
    "terminal.opening": "正在打开终端…",
    "terminal.openFailed": "打开终端失败",
    "terminal.commandCopied": "终端启动失败——命令已复制到剪贴板，请自行打开终端后粘贴：",
    ...
    "sidebar.noArchivedSessions": "暂无归档会话",
    "sidebar.agentRunning": "Agent 运行中…",
    "sidebar.newActivity": "有新活动",
    "sidebar.newSessionActivity": "会话有新活动",
    "sidebar.projectRunningCount": "{count} 个会话运行中",
    "sidebar.projectNotRunning": "暂无运行中的会话",
    "sidebar.projectUnreadCount": "{count} 个已完成的会话待查看",
    ...
    "sidebar.deleteProjectCount": "将删除该项目下的全部会话及其磁盘文件,无法撤销。",
    ...
    "sidebar.archive": "归档",
    "sidebar.archiveTitle": "移至归档",
    "sidebar.archiveAllTitle": "归档该组全部会话",
    "sidebar.unarchive": "取消归档",
    "sidebar.unarchiveTitle": "从归档恢复",
    "sidebar.unarchiveAllTitle": "恢复该组全部会话",
    "sidebar.tabConversations": "会话",
    "sidebar.tabArchive": "归档",
    ...
    "files.newFileSibling": "新增文件（同级目录）",
    "files.newFolderSibling": "新增文件夹（同级目录）",
    "files.newFileInside": "新增文件（内部）",
    "files.newFolderInside": "新增文件夹（内部）",
    "files.rename": "重命名",
    "files.delete": "删除",
    "files.fileName": "名称",
    "files.create": "创建",
    "files.confirmDelete": "将 {name} 移到废纸篓？",
    "files.confirmDeleteDirectory": "将 {name} 及其中的所有内容移到废纸篓？",
    ...
    "terminal.openWorkspace": "打开工作区终端",
    "terminal.close": "终止终端",
    ...
    "chat.fontSmaller": "缩小对话字体",
    "chat.fontLarger": "放大对话字体",
    "chat.fontReset": "重置对话字体",
    "chat.fontSize": "对话字体大小",
